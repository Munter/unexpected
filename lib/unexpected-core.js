...
(function () {
    ...
    Unexpected.prototype.diff = function (a, b, diff) {
        var that = this;
        var matchingCustomType = utils.findFirst(this.types || [], function (type) {
    ...
    var customTypePrototype = {
        ...
        diff: function (a, b, diff) {
            if (this.equal(a, b)) {
                ...
                return this.inspect(b) + ' // is missing';
            } else if (typeof b === 'undefined') {
                return this.inspect(a) + ' // was added';
            } else {
                return this.inspect(a) + ' // was ' + this.inspect(b);
            }
        },
