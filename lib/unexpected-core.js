...
(function () {
    ...
    Unexpected.prototype.diff = function (a, b) {
        ...
        if (matchingCustomType) {
            return matchingCustomType.diff(a, b, function (actual, expected) {
    ...
    var customTypePrototype = {
        ...
        diff: function (actual, expected, diff, inspect) {
            if (this.equal(actual, expected)) {
                return {
                    conflict: false,
                    text: inspect(actual),
                    annotation: ''
                ...
                return {
                    conflict: true,
                    text: inspect(actual),
                    annotation: 'should be ' + inspect(expected)
                };
            }
        },
