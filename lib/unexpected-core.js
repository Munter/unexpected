...
(function () {
    ...
    Assertion.prototype.standardErrorMessage = function () {
        ...
        return format('bold', 'expected') + ' ' +
            expect.inspect(this.subject) +
            ' ' + format('bold', this.testDescription) +
            argsString;
    };
    ...
    Unexpected.prototype.diff = function (a, b, compareForConflict) {
        var that = this;
        var matchingCustomType = utils.findFirst(this.types || [], function (type) {
        ...
        if (matchingCustomType) {
            return matchingCustomType.diff(a, b, function (a, b) {
                return that.diff(a, b, compareForConflict);
            }, compareForConflict);
        }
    };
    ...
    var customTypePrototype = {
        ...
        diff: function (a, b, diff, compareForConflict) {
            return compareForConflict(a, b);
        },
